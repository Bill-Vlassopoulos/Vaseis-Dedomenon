...
class MainWindow(QWidget):
    def __init__(self):
        ...
        welcome_label.setStyleSheet("color: white; font-size: 28px; font-family: 'Times New Roman';") 
        ...
        or_label.setStyleSheet("color: white; font-size: 13px; font-family: 'Times New Roman';")
...
class SecondWindow(QWidget):
    def __init__(self):
        ...
        create_account_button = QPushButton("Create Account", self)
        create_account_button.setStyleSheet("background-color: #ede0d4; color: black; border-radius: 10px; padding: 10px;")
        create_account_button.setFont(QFont("Times New Roman", 14))
